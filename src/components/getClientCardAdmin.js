...
import ClientCreateAdmin from "./clientCreateAdmin";
import ClientInformationAdmin from "./clientInformationAdmin";
...
const useStyles = makeStyles((theme) => ({
  ...
  export default function GetClientCardAdmin(props) {
    ...
    async function getMotvCustomer() {
      ...
      if(viewerId !== '') {
        let resultado = await fetch("http://10.5.0.53/api/v1/motvCustomer?id="+viewerId+"&vendor="+vendor_Name, {
            method: 'GET',
            headers: {
  ...
  async function searchCustomer() {
    if(loginSearch !== '') {
      ...
      if(resultado.status === 1001) {
        ...
        setError("Cliente não existe, ou não possui device")
      } else if(resultado.status !== 1001 && resultado.status !== 1600) {
        setError("Cliente não existe")
      }
      ...
      useEffect(() => {
        async function getVendors() {
         let resultado = await fetch("http://10.5.0.53/api/v1/vendor?page=0&size=30", {
             method: 'GET',
             headers: {
                 Authorization: token,
             },
              ...
              <Modal
                  ...
                  <div style={{
                     ...
                     {/*Aqui era o Orders */}
                      ...
                      <h2 style={{margin: 'auto', marginLeft: '10px', marginBottom: '20px'}}>Selecione seu Fornecedor</h2>
                          ...
                          <TableBody>
                            ...
                            {content
                              ...
                              <TableRow key={item.id_vendor}>
                                ...
                                <TableCell><p><Link target="_blank" to={"https://"+ item.url}>{item.url}</Link></p></TableCell>
                                <TableCell>
                                  <Fab  aria-label="edit" style={{width: 45, height: '100%'}} className={classes.submit}> 
                                  <Tooltip title="Buscar Cliente" placement="right-start">
                                    <Link  onClick={() => {
                                      localStorage.setItem("vendorname", item.name)
              ...
              <Modal
                  ...
                  <div style={{
                      ...
                      <div style={{width: '20%', height: '90px', minWidth: '90px', maxWidth: '90px', backgroundColor: "#616158", marginTop: '-60px', borderRadius: '10px',}}>
                        ...
                        <Tooltip title="Voltar para Fornecedores" placement="right">
                        <Link  onClick={() => {
                          localStorage.removeItem("vendorname")
                          setOpen(true);
                          setOpen2(false);
                        ...
                        <h2 style={{marginTop: '5px'}}>Clientes {vendor_Name}</h2>
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', width: '100%'}}>
                      ...
                      <h1 style={{textAlign: 'center', textShadow: '2px 5px 6px rgba(97,97,88, 0.7)', fontWeight: 'bold', fontSize: '28px', margin: 'auto auto 20px auto ', color: '#000000'}}>Ações Disponíveis:</h1>
                      ...
                      <button className="raise" style={{margin: '10px 0'}} onClick={() => {
                        ...
                        <div style={{display: 'flex', justifyContent: 'space-between', margin: 'auto 10px', fontWeight: 'bold',}}>
                            ...
                            <h2 style={{textShadow: '2px 5px 6px black', fontWeight: 'bold', fontSize: '28px', margin: 'auto 0', color: '#fff'}} >Novo Cliente</h2>
                            <div style={{width: '40px', height: '40px', borderRadius: '10px', marginTop: 'auto', marginBottom: 'auto', borderColor: '#fff', borderStyle: 'solid'}}>
                            <PersonAddOutlinedIcon style={{ color: '#fff', width: '75%', height: '75%', margin: '10%' }}/>
                        </div>
                          </div>
                      </button>
     ...
     <Table style={{marginBottom: '30px'}}>
      <TableBody>
        <TableRow >
         ...
         <TableCell style={{ minWidth: 170, textAlign: 'left'}}>{password == null || password === "" ? "Vazio" : password}</TableCell>
            ...
            marginTop: '5px'
              ...
              <Modal
                  ...
                  <div style={{
                      ...
                      <div style={{width: '20%', height: '90px', minWidth: '90px', maxWidth: '90px', backgroundColor: "#616158", marginTop: '-70px', borderRadius: '10px'}}>
                        ...
                        <h2 style={{marginTop: '5px'}}>Novo Cliente {vendor_Name}</h2>
              ...
              <Modal
                  ...
                  <div style={{
                     ...
                     {/*Aqui é a parte que renderiza a busca dos clientes pelo usuario*/} 
                     <div style={{
          width: '100%', 
          height: '100%', 
          backgroundColor: '#fff',  
      ...
      <TableBody>{
        clientSubscription.map((item) => (
          <TableRow key={item.id_customer}> 
           <TableCell style={{ minWidth: 170, textAlign: 'left'}}>{item.id_customer == null || item.id_customer === "" ? "Vazio" : item.id_customer}</TableCell>
              ...
              <Modal
                  ...
                  <div style={{
                      ...
                      <div style={{width: '20%', height: '90px', minWidth: '90px', maxWidth: '90px', backgroundColor: "#616158", marginTop: '-70px', borderRadius: '10px'}}>
                        ...
                        <h2 style={{marginTop: '5px'}}>Editar Cliente {vendor_Name}</h2>
              ...
              <Modal
                  ...
                  <div style={{
                      ...
                      <div style={{width: '20%', height: '90px', minWidth: '90px', maxWidth: '90px', backgroundColor: "#616158", marginTop: '-70px', borderRadius: '10px'}}>
                        ...
                        <h2 style={{marginTop: '5px'}}>Cliente {vendor_Name}</h2>
